...
import DashboardDependency from './scenes/dashboardDependency/Views/MainView';
import RootDashboard from './scenes/DashboardRoot';
/**
 * @class App
 * @extends {Component}
    ...
    render() {
        return (
            <Router history={hashHistory}>
                ...
                <Route path={'/dashboardapp'} component={RootDashboard} >
                    <Route path={'/dashboard'} component={DashboardDependency} />
                </Route>
