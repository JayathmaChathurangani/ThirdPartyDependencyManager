...
/**
* @class LibrariesWithLatestVersionUnknown
* @extends {Component}
* @description Get libraries of product
*/
export default class LibrariesWithLatestVersionUnknown extends React.PureComponent {
    /**
     * @class LibrariesWithLatestVersionUnknown
     * @extends {Component}
    ...
    * @class LibrariesWithLatestVersionUnknown
    * @extends {Component}
    * @description componentDidMount LibrariesWithLatestVersionUnknown
    */
    componentDidMount() {
        this.loadTable(this.props.data);// eslint-disable-line
    }
    /**
    * @classLibrariesWithLatestVersionUnknown
    * @extends {Component}
    * @param {any} data data
    * @description Load libraries of given Product/component
    */
    loadTable(data) {
        const array = [];
        if (data.length > 0) {
